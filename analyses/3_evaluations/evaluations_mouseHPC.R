...
res_list <- list(
  mouseHPC_nnSVG = rowData(readRDS(here("outputs", "results", "nnSVG", "spe_SlideSeqHippo_nnSVG_clusters.rds"))), 
  mouseHPC_nnSVG_nocovariate = rowData(readRDS(here("outputs", "results", "nnSVG", "spe_SlideSeqHippo_nnSVG.rds"))), 
  mouseHPC_SPARKX = rowData(readRDS(here("outputs", "results", "SPARKX", "spe_SlideSeqHippo_SPARKX_clusters.rds"))), 
  mouseHPC_SPARKX_nocovariate = rowData(readRDS(here("outputs", "results", "SPARKX", "spe_SlideSeqHippo_SPARKX.rds"))), 
  mouseHPC_HVGs = rowData(readRDS(here("outputs", "results", "HVGs", "spe_SlideSeqHippo_HVGs.rds")))
)

# add method names to all columns except gene IDs and gene names
colnames(res_list[["mouseHPC_nnSVG_nocovariate"]])[-1] <- 
  paste0(colnames(res_list[["mouseHPC_nnSVG_nocovariate"]]), "_nnSVG_nocovariate")[-1]
colnames(res_list[["mouseHPC_nnSVG"]])[-1] <- 
  paste0(colnames(res_list[["mouseHPC_nnSVG"]]), "_nnSVG")[-1]
colnames(res_list[["mouseHPC_SPARKX_nocovariate"]])[-1] <- 
  paste0(colnames(res_list[["mouseHPC_SPARKX_nocovariate"]]), "_SPARKX_nocovariate")[-1]
colnames(res_list[["mouseHPC_SPARKX"]])[-1] <- 
  paste0(colnames(res_list[["mouseHPC_SPARKX"]]), "_SPARKX")[-1]
colnames(res_list[["mouseHPC_HVGs"]])[-1] <- 
  paste0(colnames(res_list[["mouseHPC_HVGs"]]), "_HVGs")[-1]
...
all(res_list$mouseHPC_nnSVG$gene_name == res_list$mouseHPC_nnSVG_nocovariate$gene_name)
all(res_list$mouseHPC_nnSVG$gene_name == res_list$mouseHPC_SPARKX$gene_name)
all(res_list$mouseHPC_nnSVG$gene_name == res_list$mouseHPC_SPARKX_nocovariate$gene_name)
